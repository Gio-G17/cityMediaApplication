...
class AppColors {
  ...
  // Define the color for icons
  static const Color iconsColorActive = Color(0xFFFFFFFF);
  ...
  // Define the tertiary color
  static const Color textTertiaryColor = Color(0xFFFFFFFF);

  // Define the wave color (for the radio visualizer or waveform)
  static const Color waveColor = Color(0xFFFFFFFF);
}
